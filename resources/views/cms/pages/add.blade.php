    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="card card-custom">
                <form class="form" action="{{url('tavsiocms/pages/add')}}" method="post">
                    {{csrf_field()}}
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Başlık :</label>
                                    <input type="text" name="title" class="form-control form-control-solid" placeholder="Sayfa Başlığı"/>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-solid" rows="3"
                                      name="description" id="description" placeholder="Sayfa Seo Açıklaması"></textarea>
                        </div>
                        <div class="form-group">
