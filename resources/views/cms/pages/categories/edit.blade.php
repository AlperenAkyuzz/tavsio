    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <a href="{{url('tavsiocms/pages/categories')}}" class="btn btn-light-primary font-weight-bolder btn-sm mr-3">
                    <i class="fas fa-hand-point-left"></i> Geri Dön
                </a>
                <a href="{{url('tavsiocms/pages/categories')}}" class="btn btn-light-danger font-weight-bolder btn-sm">
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="card card-custom">
                <form class="form" action="{{url('tavsiocms/pages/category-edit/'.$pagesCategory->uuid)}}" method="post">
                    {{csrf_field()}}
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control form-control-solid"
                                   placeholder="Kategori Başlığı" value="{{$pagesCategory->title}}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-list">
                                <label class="checkbox">
                                    <input type="checkbox" name="status" value="1" @if($pagesCategory->status == 1) {{'checked'}} @endif/>
                                    <span></span>
                                    Aktif
                                </label>
                            </div>
