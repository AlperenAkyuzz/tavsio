    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="card card-custom">
                <form class="form" action="{{url('tavsiocms/pages/category-add')}}" method="post">
                    {{csrf_field()}}
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control form-control-solid" placeholder="Kategori Başlığı"/>
