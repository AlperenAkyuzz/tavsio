    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="card card-custom">
                <form class="form" action="{{url('tavsiocms/region/districts/edit/'.$district->uuid)}}" method="post">
                    {{csrf_field()}}
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>İlçe :</label>
                            <input type="text" name="district" class="form-control form-control-solid"
                                   placeholder="İlçe" value="{{$district->district}}"/>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker" name="city_id" required>
                                ...
                                @foreach($cities as $city)
                                    <option value="{{$city->id}}" @if($city->id==$district->city_id){{"selected"}} @endif >{{$city->city}}</option>
                                @endforeach
                            </select>
                        </div>
