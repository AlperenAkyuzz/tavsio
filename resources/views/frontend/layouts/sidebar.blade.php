<div class="fixed-sidebar left">
    <div class="left-menu-full">
        <ul class="menu-slide">
            <li><a class="closd-f-menu" href="#" title=""><i class="fa fa-times"></i> close Menu</a></li>
            <li class="menu-item-has-children"><a class="" href="#" title=""><i class="fa fa-home"></i> Açılır Menü</a>
                <ul class="submenu">
                    <li><a href="index.html" title="">Pitnik Default</a></li>
                    <li><a href="company-landing.html" title="">Company Landing</a></li>
                </ul>
            </li>
            <li class="menu-item"><a class="" href="#" title=""><i class="fa fa-star-o"></i>Link</a>
