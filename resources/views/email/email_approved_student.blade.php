        ...
        <td style="word-break: break-word; vertical-align: top; border-collapse: collapse;" valign="top">
            <div style="background-color:transparent;">
                <div class="block-grid" data-body-width-father="650px" rel="col-num-container-box-father"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;background-position:top center;background-repeat:no-repeat">
                        <!--[if (mso)|(IE)]>
                        ...
                        <td align="center" width="650"
                            style="width:650px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:55px; padding-bottom:60px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div style="color:#052D3D;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:0px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 12px; color: #052D3D;">
                                            <p style="line-height: 26px; text-align: center; font-size: 12px; margin: 0;">
                                                <span style="font-size: 22px;"><strong>{{ $getUser->firstname.' '.$getUser->lastname }}</strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <div style="color:#052D3D;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:0px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 12px; color: #052D3D;">
                                            <p style="line-height: 26px; text-align: center; font-size: 12px; margin: 0;">
                                                <span style="font-size: 14px;"><strong>
                                                        Sayın ilgili {{ $getUser->firstname.' '.$getUser->lastname }} öğretmenimiz {{ $getUserTwo->firstname.' '.$getUserTwo->lastname }} ile anlaşmış bulunmaktasınız.Derslerinizin takibini düzenli olarak panelinizden takip edebilirsiniz.
                                                        Her ders sonrasında öğretmenimizin dersle alakalı görüşleri sizlere mesaj olarak gönderilecektir. Ayrıca öğretmenimizin aylık raporlaması sizlere her ay sonrası mail olarak gönderilecektir.
                                                        Panelinizi aktif olarak kullanmak o sebepten önem arz etmektedir. Öğretmenimize ödemeyi her ders çıkışı elden bir zarf içerisinde nakit olarak yapabilirsiniz.
                                                        Karşılaştığınız herhangi bir sorunda bizlere istediğiniz zaman mesaj ve arama yoluyla ulaşabileceğiniz gibi güzel geri dönüşlerinizi de beklemekteyiz.
                                                        Öğretmenimiz hakkındaki yorum ve görüşlerinizi panelinize ekleyebilirsiniz.
                                                        Ayrıca sizin çalışma yaptığınız farklı öğretmenleri bizlere önerebilir ya da bizimle bu şekilde çalışma yapmasını istediğiniz velilerimize de bizleri önerebilirsiniz.
                                                        İyi çalışmalar dileriz. Saygılarımızla.
                                                    </strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <div style="line-height:120%;padding-top:36px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <p style="line-height: 26px; text-align: center; font-size: 12px; margin: 0;">
                                            <a href="{{$link}}" style="background-color:#EB7035;border:1px solid #EB7035;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:44px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;mso-hide:all;">Hesabına git &rarr;</a>
                                        </p>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if (!mso)&(!IE)]><!-->
                ...
                <div class="block-grid" data-body-width-father="650px" rel="col-num-container-box-father"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                        ...
                        <td align="center" width="650"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-right: 0px; padding-left: 0px; padding-top:0px; padding-bottom:20px;">
                        <![endif]-->
                        <div class="col num12" data-body-width-son="650" rel="col-num-container-box-son"
                             style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top;">
                            <div style="width:100% !important;">
                                            ...
                                            <tr>
                                                <td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 href="#"
                                                                 style="height:34.5pt; width:216pt; v-text-anchor:middle;"
                                                                 arcsize="33%" stroke="false" fillcolor="#fc7318">
                                                        <w:anchorlock/>
