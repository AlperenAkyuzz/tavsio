...
This functions hide show add post icon
========================================== */
/*
$(window).scroll(function () {
    if ($(window).scrollTop() >= 300) {
        $('.new-button-li').css('opacity', '1');
    } else {
        $('.new-button-li').css('opacity', '0');
    }
});*/
...
// select pay method on donation page
    ...
    $('.send-mesg').on('click', function () {
        $('.send-message-modal').addClass('active');
...
//------ scrollbar plugin
    ...
    $('.menu-small').on("click", function () {
        let menuside = $('.fixed-sidebar.left');
        menuside.not(menuside).removeClass("open");
